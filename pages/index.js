...
import { Disclosure, Menu, Transition } from '@headlessui/react'; // , Combobox 
import { SearchIcon } from '@heroicons/react/solid';
import { BellIcon, MenuIcon, XIcon } from '@heroicons/react/outline'; // , UsersIcon
...
const handleSubmitMain = async (e) => {
  ...
  setKeyword(mainKeyword.value.replace(/\s/g, '').toUpperCase());
};

const handleSubmit = async (e) => {
    e.preventDefault();
    const { searchKeyword } = e.target.elements;
    setKeyword(searchKeyword.value.replace(/\s/g, '').toUpperCase());
};
...
useEffect(() => {
  ...
  <div>
      ...
      {data?.dataset_recent_month?.all_labels && data?.dataset_recent_month?.all_device_absolute_counts?.length > 5 && data?.dataset_recent_month?.all_labels?.length === data?.dataset_recent_month?.all_device_absolute_counts?.length
      ...
      <div>
        <MainChart
            ...
            isRecentMonth={true} 
            isRecentThreeMonths={false} 
            isRecentSixMonths={false} 
            isRecentYear={false}
            isFullRange={false} 
            labels={data?.dataset_recent_month?.all_labels}
            all_device_absolute_counts={data?.dataset_recent_month?.all_device_absolute_counts}
            mobile_absolute_counts={data?.dataset_recent_month?.mobile_absolute_counts}
            pc_absolute_counts={data?.dataset_recent_month?.pc_absolute_counts}
        />

        {/* 최근 3개월 그래프 */}
        {data?.dataset_recent_three_months?.all_labels && data?.dataset_recent_three_months?.all_device_absolute_counts?.length > 5 && data?.dataset_recent_three_months?.all_device_absolute_counts?.length === data?.dataset_recent_three_months?.mobile_absolute_counts?.length
        ...
        <div className="mt-4 hidden sm:block">
          <MainChart
              keyword={data?.keyword} 
              isRecentMonth={false}
              isRecentThreeMonths={true} 
              isRecentSixMonths={false} 
              isRecentYear={false} 
              isFullRange={false} 
              labels={data?.dataset_recent_three_months?.all_labels}
              all_device_absolute_counts={data?.dataset_recent_three_months?.all_device_absolute_counts}
              mobile_absolute_counts={data?.dataset_recent_three_months?.mobile_absolute_counts}
              pc_absolute_counts={data?.dataset_recent_three_months?.pc_absolute_counts}
          />
        </div>
        ...
        {/* 최근 6개월 그래프 */}
        {data?.dataset_recent_six_months?.all_labels && data?.dataset_recent_six_months?.all_device_absolute_counts?.length > 5 && data?.dataset_recent_six_months?.all_device_absolute_counts?.length === data?.dataset_recent_six_months?.mobile_absolute_counts?.length // data?.all_labels_recent_six_months && data?.all_device_recent_six_months_counts?.length === data?.mobile_recent_six_months_counts?.length
        ...
        <div className="mt-4 hidden sm:block">
          <MainChart
              ...
              isRecentMonth={false}
              isRecentThreeMonths={false} 
              isRecentSixMonths={true} 
              isRecentYear={false} 
              isFullRange={false} 
              labels={data?.dataset_recent_six_months?.all_labels}
              all_device_absolute_counts={data?.dataset_recent_six_months?.all_device_absolute_counts}
              mobile_absolute_counts={data?.dataset_recent_six_months?.mobile_absolute_counts}
              pc_absolute_counts={data?.dataset_recent_six_months?.pc_absolute_counts}
          />
        </div>
        ...
        {/* 최근 1년 그래프 */}
        {/* {data?.dataset_recent_year?.all_labels && data?.dataset_recent_year?.all_device_absolute_counts?.length > 5 && data?.dataset_recent_year?.all_device_absolute_counts?.length === data?.dataset_recent_year?.mobile_absolute_counts?.length
        ...
        <div className="mt-4 hidden sm:block">
          <MainChart
              ...
              isRecentYear={true} 
              isFullRange={false} 
              labels={data?.dataset_recent_year?.all_labels}
              all_device_absolute_counts={data?.dataset_recent_year?.all_device_absolute_counts}
              mobile_absolute_counts={data?.dataset_recent_year?.mobile_absolute_counts}
              pc_absolute_counts={data?.dataset_recent_year?.pc_absolute_counts}
          />
        </div>
        ...
        {/* 전체 기간 (Full Range) 그래프 */}
        {/* {data?.dataset_full_range?.all_labels && data?.dataset_full_range?.all_device_absolute_counts?.length > 5 && data?.dataset_full_range?.all_device_absolute_counts?.length === data?.dataset_full_range?.mobile_absolute_counts?.length
        ...
        <div className="mt-4">
          <MainChart
              ...
              isRecentYear={false} 
              isFullRange={true} 
              labels={data?.dataset_full_range?.all_labels}
              all_device_absolute_counts={data?.dataset_full_range?.all_device_absolute_counts}
              mobile_absolute_counts={data?.dataset_full_range?.mobile_absolute_counts}
              pc_absolute_counts={data?.dataset_full_range?.pc_absolute_counts}
          />
        </div>
      ...
      <SearchVolumeItem
          key={idx}
          item={item}
          isMainKeyword={data?.keyword === item?.relKeyword}
          search_date={data?.search_date}
          keyword={data?.keyword}

          all_device_recent_year_absolute_counts_sum={data?.dataset_recent_year?.all_device_absolute_counts_sum}
          mobile_recent_year_absolute_counts_sum={data?.dataset_recent_year?.mobile_absolute_counts_sum}
          pc_recent_year_absolute_counts_sum={data?.dataset_recent_year?.pc_absolute_counts_sum}

          begin_date_in_recent_month={data?.dataset_recent_month?.selected_begin_date}
          end_date_in_recent_month={data?.dataset_recent_month?.selected_end_date}
          begin_date_in_recent_year={data?.dataset_recent_year?.selected_begin_date}
          end_date_in_recent_year={data?.dataset_recent_year?.selected_end_date}
      />
