import {
  ...
  const data = {
    ...
    datasets: [
      {
        label: `Total 검색량${isRecentMonth ? " (최근 1달)" : isRecentYear ? " (최근 1년)" : ""}`,
        data: all_device_absolute_counts,
        borderColor: "rgb(15, 216, 103)",
        backgroundColor: "rgba(15, 216, 103, 0.5)",
      },
      {
          label: `Mobile 검색량${isRecentMonth ? " (최근 1달)" : isRecentYear ? " (최근 1년)" : ""}`,
          data: mobile_absolute_counts,
          borderColor: "rgb(255, 99, 132)",
          backgroundColor: "rgba(255, 99, 132, 0.5)",
        },
      {
        label: `PC 검색량${isRecentMonth ? " (최근 1달)"  : isRecentYear ? " (최근 1년)" : ""}`,
